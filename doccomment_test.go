...
// review of #503.
// THE OPTIONAL CARRIAGE RETURN IS NOT COSMETIC, and the two answers
// disagree without it. Go's (?m)$ matches before \n only, while
// go/scanner strips a trailing \r from a // comment before
// ast.IsGenerated compares it. Measured on
// "// Code generated by protoc-gen-go. DO NOT EDIT.\r\n\r\npackage fake\r\n":
//
//	IsGenerated=true   `…DO NOT EDIT\.$`=false   `…DO NOT EDIT\.\r?$`=true
//
// So on a clone with core.autocrlf=true, the test below reddens on
// every .pb.go at once and sends the reader looking for a hand-written
// marker that is not there — and the floor's own `grep -rLE` advice is
// wrong in the same run, which is the arm this const exists to keep
// honest. \r? is still a valid ERE, so the printed command is unchanged
// in meaning. Raised in review of #503.
const generatedMarkerPattern = `^// Code generated .* DO NOT EDIT\.\r?$`
