...
var defMenuItem = &ElementDef{
	...
	Attrs: []AttrSpec{
		...
		{Name: "Icon", Kind: KindString, Binds: BindsLiteral, GoType: "image.Image", Origin: OriginBuiltin,
		...
		{Name: "IconRune", Kind: KindString, Binds: BindsLiteral, GoType: "rune", Origin: OriginBuiltin,
