...
- Prebuilt demo binaries and .gooey files are staged in ${S} (probe, pixels, props, logview, markuplog, finder, reader, state + all .gooey files). Use the prebuilt binary; rebuild only if it is missing or crashes at startup.
...
const GIF_SCHEMA = {
  ...
  properties: {
    ...
    runCmd: { type: 'string', description: 'how a user runs this demo, e.g. go run ./cmd/props' },
...
const ORDER = ['pixels', 'props', 'logview', 'markuplog', 'finder', 'reader', 'state']
const byOrder = (a, b) =>
