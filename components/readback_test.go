...
// text, a whole frame as rows, a whole composition — plus reversedText,
// which reads a STYLE rather than text and so answers a different
// question, and the one row search every positional assertion in this
// package needs.
//
...
// it made both wrong at once with nothing to go red. It was wrong twice
// over by the time it was removed — frameRows and reversedText arrived
// on two different branches. The declarations are the inventory.
//
